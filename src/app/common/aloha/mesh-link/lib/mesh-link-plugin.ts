...
define([
	...
	function setupMetaClickLink(editable) {
		editable.obj.delegate('a', 'click.aloha-link.meta-click-link', function (e: any) {
	...
	return Plugin.create('mesh-link', {
		...
		createButtons: function () {
			...
			this.hrefField = AttributeField({
				...
				width: 320,
				valueField: 'url',
				cls: 'aloha-link-href-field md-input',
				scope: 'Aloha.continuoustext',
			...
			this._selectNodeButton = Ui.adopt("selectNode", Button, {
				tooltip: 'Select Node',
