module meshAdminUi {
     ...
     */
    function i18nServiceProvider(): any {
         ...
         */
        this.setDefaultLanguage = function (value: string) {
            if (!isValidIsoLanguage(value)) {
                throw new Error('i18nServiceProvider#setDefaultLanguage: "' + value + '" is not a valid ISO-639-1 code.');
            }
         ...
         * e.g. ['en', 'de', 'fr']
         */
        this.setAvailableLanguages = function (value: string[]) {
            if (Array.isArray(value)) {
                value.forEach(code => {
                    if (!isValidIsoLanguage(code)) {
                        throw new Error('i18nServiceProvider#setAvailableLanguages: "' + code + '" is not a valid ISO-639-1 code.');
                    }
                });
    ...
    export class I18nService {
        ...
        /**
         * Returns an object has of ISO-639-1 codes and the language's name and
    ...
    /**
     * Returns true if the code is a valid ISO-639-1 code.
     */
    function isValidIsoLanguage(code: string): boolean {
        return -1 < Object.keys(ISO_LANGUAGES).indexOf(code);
    }
