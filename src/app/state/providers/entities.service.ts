...
export class EntitiesService {
    ...
    getNodeGraphQLDescription() {

        const fieldQueries = this.getAllSchemas().map(category => {
        ...
        return `
            availableLanguages #different from REST
            breadcrumb {
                displayName,
                project { #projectName on REST
                name
                }
                schema {
                name,
            ...
            childrenInfo: children { #completely different
                elements {
                schema {
                    name
                    uuid
            ...
            parentNode: parent {
                uuid
                displayName
                projectName: project { #would be nice to flatten
                name
                }
                schema {
                uuid
