        ...
        dataService.persistContent(projectName, content)
            .then(function(response) {
                if (vm.isNew) {
                    ...
                    content = response;
                    wipService.openItem(wipType, content, { projectName: projectName, selectedLangs: vm.selectedLangs });
                    vm.isNew = false;
        ...
        if (currentNodeId) {
            ...
            if (wipContent) {
                ...
                return dataService
                    ...
                    .then(function (data) {
                        vm.content = data;
                        wipService.openItem(wipType, data, { projectName: projectName, selectedLangs: vm.selectedLangs });
            ...
            return dataService.getSchema(schemaId)
                .then(function(schema) {
                    ...
                    wipService.openItem(wipType, vm.content, { projectName: projectName, isNew: true, selectedLangs: vm.selectedLangs });
                    return schema;
                });
        }
    }
