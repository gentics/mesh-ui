...
@Component({
    selector: 'mesh-permissions-role-list',
    templateUrl: './permissions-role-list.component.html',
    styleUrls: ['./permissions-role-list.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class PermissionsRoleListComponent implements OnInit, OnDestroy {
