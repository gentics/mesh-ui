...
describe('Thumbnail', () => {
                    ...
                    '4d1cabf1382e41ea9cabf1382ef1ea7c': mockMeshNode({
                        ...
                        fields: {
                            ...
                            image: {
                                ...
                                height: 508,
                                sha512sum:
                                    '45d976266c7e702ad96b9e0c44f504b9957619dbc5436b9937f919a5b3' +
                    ...
                    '9b41402a3925434d81402a3925e34d93': mockMeshNode({
                        ...
                        fields: {
                            ...
                            binary: {
                                fileName: 'small.mp4',
                                sha512sum:
                                    '549c53a072a80adcf0ca8c620c0a25da0be964724e428ecb13dc64bee4f2b93e819' +
    ...
    it(
        `does not use Mesh image API when no dimension parameters are given`,
        componentTest(
            () => TestComponent,
            fixture => {
                const component: TestComponent = fixture.debugElement.componentInstance;
    ...
    it(
        `uses Mesh image API when dimension parameters are given`,
        componentTest(
            () => TestComponent,
            fixture => {
                const dimensions = {
    ...
    it(
        `displays nothing if uuid is invalid`,
        componentTest(
            () => TestComponent,
            fixture => {
                const component: TestComponent = fixture.debugElement.componentInstance;
    ...
    it(
        `displays nothing if uuid is not set`,
        componentTest(
            () => TestComponent,
            fixture => {
                fixture.detectChanges();
    ...
    describe('file placeholder', () => {
        ...
        it(
            `has a default size of 128px wide if none is provided`,
            componentTest(
                () => TestComponent,
                fixture => {
                    const component: TestComponent = fixture.debugElement.componentInstance;
...
function hasQueryParameters(url: string, params: any): boolean {
    ...
    return Object.keys(params).every(key => urlparams.get(key) === params[key].toString());
}
